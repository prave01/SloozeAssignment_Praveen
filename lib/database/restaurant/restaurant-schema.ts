...
export const locationEnumRestaurant = pgEnum("location", ["america", "india"]);
...
export const restaurant = pgTable("restaurant", {
  ...
  location: locationEnumRestaurant().notNull(),
});
...
export const paymentMethod = pgTable("payment_method", {
  ...
  location: locationEnumRestaurant().notNull().default("america"),
});
